...
const SIMPLE_MAIL_REGEXP = "[\\w]+@[\\w]{2,}\\.[\\w]{2,}(\\.[\\w]{2,})?"
const MAIL_REGEXP = SIMPLE_MAIL_REGEXP

var disallowedExtensions = []string{"png", "gif", "jpg", "jpeg"}

var disallowedDomainsMutex sync.Mutex
